...
all_data <- read.csv('./data/raw_observations/prokaryote_sgr.csv', header=TRUE)
...
##### SGR DATA, EXTRACT MEDIAN AND QUANTILES
sgr_dat <- read.csv('./data/raw_observations/prokaryote_gge.csv', header=TRUE)
quantile(sgr_dat$BGE)