### Figure S11: Climate change projections on temperature and bacteria cell-carbon
...
ggsave(plot = figure, filename = "figures/FigureS11.jpeg", width = 178, height = 75, units = "mm")

write.csv(year_data_gg, "./source_data/FigureS11/FigureS11.csv", row.names = FALSE)
