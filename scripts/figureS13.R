## Figure S13: Final parametric model of prokaryotic abundance
...
fig1a_line <- line_dat %>% rename(log10_prokaryote_abundance_mL_mean = "Value", log10_prokaryote_abundance_mL_95lowerbound = "Lower", log10_prokaryote_abundance_mL_95upperbound = "Upper") 

dot_dat <- data.frame("logdepth" = tt$res$logdepth, "Value" = tt$res$visregRes)
fig1a_points <- dot_dat %>% rename(log10_prokaryote_abundance_mL = "Value") 
...
ggpubr::ggexport(figure, filename = paste("./figures/FigureS13.png", sep = ""), width = 1250, height = 700)


### Save Figure S13 source data
wb <- createWorkbook(type = "xls")

sh2 <- createSheet(wb,sheetName = "Figure S13a_Points")
addDataFrame(data.frame("Figure S13a_Points"=c("Figure S13a_Points")),sheet = sh2,row.names = FALSE,startRow = 1,col.names = FALSE)
addDataFrame(fig1a_points,sheet = sh2,row.names = FALSE,startRow = 2)

sh2 <- createSheet(wb,sheetName = "Figure S13a_Line")
addDataFrame(data.frame("Figure S13a_Line"=c("Figure S13a_Line")),sheet = sh2,row.names = FALSE,startRow = 1,col.names = FALSE)
addDataFrame(fig1a_line,sheet = sh2,row.names = FALSE,startRow = 2)

sh2 <- createSheet(wb,sheetName = "Figure S13b_Points")
addDataFrame(data.frame("Figure S13b_Points"=c("Figure S13b_Points")),sheet = sh2,row.names = FALSE,startRow = 1,col.names = FALSE)
addDataFrame(fig1b_points,sheet = sh2,row.names = FALSE,startRow = 2)

sh2 <- createSheet(wb,sheetName = "Figure S13b_Line")
addDataFrame(data.frame("Figure S13b_Line"=c("Figure S13b_Line")),sheet = sh2,row.names = FALSE,startRow = 1,col.names = FALSE)
addDataFrame(fig1b_line,sheet = sh2,row.names = FALSE,startRow = 2)

sh2 <- createSheet(wb,sheetName = "Figure S13c_Points")
addDataFrame(data.frame("Figure S13c"=c("Figure S13c")),sheet = sh2,row.names = FALSE,startRow = 1,col.names = FALSE)
addDataFrame(fig1c_points,sheet = sh2,row.names = FALSE,startRow = 2)

sh2 <- createSheet(wb,sheetName = "Figure S13c_Line")
addDataFrame(data.frame("Figure S13c_Line"=c("Figure S13c_Line")),sheet = sh2,row.names = FALSE,startRow = 1,col.names = FALSE)
addDataFrame(fig1c_line,sheet = sh2,row.names = FALSE,startRow = 2)

sh2 <- createSheet(wb,sheetName = "Figure S13d_Points")
addDataFrame(data.frame("Figure S13d_Points"=c("Figure S13d_Points")),sheet = sh2,row.names = FALSE,startRow = 1,col.names = FALSE)
addDataFrame(fig1d_points,sheet = sh2,row.names = FALSE,startRow = 2)

sh2 <- createSheet(wb,sheetName = "Figure S13d_Line")
addDataFrame(data.frame("Figure S13d_Line"=c("Figure S13d_Line")),sheet = sh2,row.names = FALSE,startRow = 1,col.names = FALSE)
addDataFrame(fig1d_line,sheet = sh2,row.names = FALSE,startRow = 2)

sh2 <- createSheet(wb,sheetName = "Figure S13e_Points")
addDataFrame(data.frame("Figure S13e_Points"=c("Figure S13e_Points")),sheet = sh2,row.names = FALSE,startRow = 1,col.names = FALSE)
addDataFrame(fig1e_points,sheet = sh2,row.names = FALSE,startRow = 2)

sh2 <- createSheet(wb,sheetName = "Figure S13e_Line")
addDataFrame(data.frame("Figure S13e_Line"=c("Figure S13e_Line")),sheet = sh2,row.names = FALSE,startRow = 1,col.names = FALSE)
addDataFrame(fig1e_line,sheet = sh2,row.names = FALSE,startRow = 2)

saveWorkbook(wb,"./source_data/FigureS13/FigureS13.xls")
