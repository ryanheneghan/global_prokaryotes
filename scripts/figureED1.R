## EXTENDED DATA FIGURE 1: Data distribution and stat model residuals for bacteria cell carbon model
...
ggpubr::ggexport(kk, filename ="./figures/FigureED1.png",  width = 800, height = 250)
