## Supplementary Figure S5: Environmental variables in epi, meso and bathypelagic
...
ggsave(plot = figure2, filename = "figures/FigureS5.jpeg", width = 178, height = 120, units = "mm")
