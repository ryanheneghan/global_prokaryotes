### Figure S10: Temperature impacts on biomass
...
load("./models/lm_model_final.RData")
load("./models/glmm_model1_carbon.RData")
...
ggsave(plot = plot1, filename = "figures/FigureS10.jpeg", width = 90, height = 75, units = "mm")

write.csv(pred_data, "./source_data/FigureS10/FigureS10.csv", row.names = FALSE)
