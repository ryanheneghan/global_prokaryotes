### ABUNDANCE STATISTICAL MODEL FOR PROKARYOTES
...
write.csv(rf$importance, "./data/node_purity.csv", row.names = FALSE)
...
save(rf,file = "./models/rf_model2.RData")
...
save(gam1, file = "./models/gam_abundance.RData")
...
save(gm1, file = "./models/lm_abundance.RData")
