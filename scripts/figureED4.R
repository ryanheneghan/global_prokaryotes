## EXTENDED DATA FIGURE 4, specific-production rate statistical model
...
ggpubr::ggexport(figure, filename = paste("./figures/FigureED4.png", sep = ""), width = 1000, height = 400)
