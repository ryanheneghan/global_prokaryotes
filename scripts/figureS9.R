...
## Import data
all_heteros <- read.csv("./data/epipelagic_all_heterotroph_biomass.csv", row.names = FALSE)
...
write.csv(all_heteros, "./data/epipelagic_all_heterotroph_biomass.csv", row.names = FALSE)
...
write.csv(bac_frac_data, "./source_data/FigureS9.csv", row.names = FALSE)
