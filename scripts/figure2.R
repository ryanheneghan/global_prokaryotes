...
write.csv(epipelagic, "./source_data/Figure2_3_S5/epipelagic.csv", row.names = FALSE)
write.csv(mesopelagic, "./source_data/Figure2_3_S5/mesopelagic.csv", row.names = FALSE)
write.csv(bathypelagic, "./source_data/Figure2_3_S5/bathypelagic.csv", row.names = FALSE)
