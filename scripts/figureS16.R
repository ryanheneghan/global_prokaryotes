### Figure S16: RAW RELATIONSHIP BETWEEN PROK CELL CARBON AND FULL PREDICTOR VARIABLES
...
for(i in 1:length(x_names)){
  ...
  header_name <- paste("Figure S16", tagss[i], sep = "")
...
saveWorkbook(wb,"./source_data/FigureS16/FigureS16.xls")
...
ggpubr::ggexport(figure, filename = paste("./figures/FigureS16.png", sep = ""), width = 800, height =600)
