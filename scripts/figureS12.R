...
bathy_data <- read.csv("./data/bathy_data.csv")
...
bge_data <- read.csv("./data/raw_observations/prokaryote_gge.csv")
...
write.csv(store_outputs, "./store_outputs/FigureS12.csv", row.names = FALSE)
