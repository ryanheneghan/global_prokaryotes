## FIGURE 2: Data distribution and stat model residuals for bacteria cell carbon
...
############################################
curr_bac <- read.csv('./malaspina_locations.csv') # Import malaspina locations
...
ggpubr::ggexport(kk, filename ="./figures/Figure2.png",  width = 800, height = 250)
