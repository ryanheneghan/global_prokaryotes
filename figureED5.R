## Extended Data Figure 1: Map of surface chlorophyll
...
## Import data
all_data <- data.table::fread("contemporary_bacteria.csv")
...
ggsave(plot = plot_chl, filename = "figures/FigureE1.jpeg", width = 90, height = 60, units = "mm")
